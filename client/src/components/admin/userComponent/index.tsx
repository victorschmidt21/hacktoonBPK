...
export function UserComponent({ user }: { user: UserAttributes }) {
          ...
          <div className="flex items-center space-x-6 mb-4">
            ...
            <div>
              ...
              <h2 className="text-md text-gray-800">
                Tipo de usuário: {capitalizeFirstLetter(user.type)}
              </h2>
            </div>
          </div>
          <div className="space-y-4 flex flex-col items-center">
            <GrEdit size={20} className="cursor-pointer"/>
